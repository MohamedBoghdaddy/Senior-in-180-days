# Day 169 - Senior communication rehearsal
...
| Field | Daily plan |
|-------|------------|
| Primary objective | Senior communication rehearsal |
...
| Artifact required | `tracking/notes/day-169.md` with code, docs, or command evidence |
...
`tracking/notes/day-169.md` with code, docs, or command evidence
