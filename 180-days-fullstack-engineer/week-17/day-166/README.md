...
| Field | Daily plan |
|-------|------------|
| Primary objective | Case study writeup |
...
| Artifact required | `tracking/notes/day-166.md` with code, docs, or command evidence |
...
`tracking/notes/day-166.md` with code, docs, or command evidence
