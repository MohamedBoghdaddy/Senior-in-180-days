# Day 162 - ADR index and decision cleanup
...
| Field | Daily plan |
|-------|------------|
| Primary objective | ADR index and decision cleanup |
...
| Artifact required | `tracking/adrs/day-162-adr-index-and-decision-cleanup.md` |
...
`tracking/adrs/day-162-adr-index-and-decision-cleanup.md`
