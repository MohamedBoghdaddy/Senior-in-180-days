...
| Field | Daily plan |
|-------|------------|
| Primary objective | Portfolio README |
...
| Artifact required | `tracking/notes/day-163.md` with code, docs, or command evidence |
...
`tracking/notes/day-163.md` with code, docs, or command evidence
