...
| Artifact required | `tracking/notes/day-165.md` with code, docs, or command evidence |
...
`tracking/notes/day-165.md` with code, docs, or command evidence
